...
namespace Mediavince\DoctrineFixturesBundle\Command;
...
// the whole point of this bundle resides in the fact the Loader::loadFromDirectory can accept file instead of just dir...
// the Loader::loadFromFile is also available for better compliance but really just does the same... as loadFromDirectory
use Mediavince\DoctrineFixturesBundle\Common\DataFixtures\Loader as DataFixturesLoader;
...
Or the path of a file containing a fixture class:

  <info>./app/console doctrine:fixtures:load --fixtures=/path/to1/fixtures1.php --fixtures=/path/to2/fixtures2.php</info>
...
EOT
    ...
    protected function execute(InputInterface $input, OutputInterface $output)
    {
        ...
        foreach ($paths as $path) {
            // either use case or see below, where directory can also accept file @see ../Common/Loader.php
//            if (is_dir($path)) {
